...
oo_27L27R <- oo[,c(1:4,8:10,14:21)] # df with only the samples in the current pairwise comparison
...
oo_30L30R <- oo[,c(1,5:7,11:13,14:21)] # df with only the samples in the current pairwise comparison
...
oo_30L27R <- oo[,c(1,5:10,14:21)] # df with only the samples in the current pairwise comparison
...
oo_30R27R <- oo[,c(1,8:21)] # df with only samples in the current pairwise comparison
...
oo_30L27L <- oo[,c(1:7,14:21)] # df with only samples in the current pairwise comparison
...
co_27L27R <- co[,c(1:4,8:10,14:21)] # df with only the samples in the current pairwise comparison
...
co_30L30R <- co[,c(1,5:7,11:13,14:21)] # df with only samples in the current pairwise comparison
...
co_30L27R <- co[,c(1,5:10,14:21)] # df with only the samples in the current pairwise comparison
...
co_30R27R <- co[,c(1,8:21)] # df with only the samples in the current pairwise comparison
...
co_30L27L <- co[,c(1:7,14:21)] # df with only the samples in the current pairwise comparison
